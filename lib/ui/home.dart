...
class _HomeScreenState extends State<HomeScreen> {
  ...
  FbGetPostController getPostControllerController = Get.put(FbGetPostController());
                              ...
                              Row(
                                children: [
                                 ...
                                 Obx(() =>   controller.likeCounts != 0
                                            ...
                                            return AlertDialog(
                                              ...
                                              content: SizedBox(
                                                ...
                                                child: ListView.builder(
                                                    itemCount: controller.likeCount(post.id)     ,
                                                    itemBuilder: (context, index) {
                                    ...
                                    child: Text(
                                      '${controller.likeCount(post.id) != 0
                                          ? controller.likeCount(post.id)
                                          : ''} '
